...
public class DriverNPCSpawner
{
    ...
    public void Spawn() {
       ...
       // Object.Instantiate(new GameObject(),position, Quaternion.identity);
        ...
        CarNPC newNPC = NewNPCHolder.AddComponent<CarNPC>();
    ...
    private Driver chooseNPCType() {
        ...
        foreach (WeightCharacterPair chance in spawnChancesCont.spawnChances) {
            ...
            if (randomNum <= chance.weight + cumulativeChance) {chosenDriver = chance.type;  break;}
